...
- Then we would ensure that we can connect and access our database through Google Shell by using the command ``` mysql -u _username__ -h _host(IP-address)___ -p```_
